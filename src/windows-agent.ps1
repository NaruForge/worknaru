...
# The supervisor joins its job BEFORE starting the agent, so every descendant
...
public static class WorkNaruJob {
    ...
    static void Agent(IntPtr job, Stream input, string executable, string[] arguments, string cwd) {
