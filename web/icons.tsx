export function Icon({ name }: { name: 'chat' | 'list' | 'close' | 'plus' | 'arrow' | 'stop' | 'settings' | 'folder' | 'sun' | 'moon' | 'grid' | 'sparkles' | 'reasoning' }) {
  const paths = {
    ...
    reasoning: 'M12 4v16M12 5C7 1 3 6 6 9c-5 2-2 7 1 7-1 5 5 5 5 1m0-12c5-4 9 1 6 4 5 2 2 7-1 7 1 5-5 5-5 1M6 9l3 2m9-2-3 2M7 16l2-2m8 2-2-2',
  };
  return <svg className="ui-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d={paths[name]} /></svg>;
}
