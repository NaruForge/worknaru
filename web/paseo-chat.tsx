...
export function PaseoChatApp({ model, appearance }: { model: ChatModel; appearance: ColorPreference }) {
  ...
  return <div className={`window paseo-product ${mobile ? 'window--stacked' : ''}`}>
